...
const SITE = 'https://x26589334-cpu.github.io/gumi-tutoring';
...
<title>구미과외 학습 소식</title>
<link>${SITE}/blog.html</link>
<description>경상북도 구미시 지역 과외·학습 정보</description>
...
push('', '1.0');
['schools.html','teachers.html','online.html','blog.html','centers.html'].forEach(p => push(p, '0.9'));
